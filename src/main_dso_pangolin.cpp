...
#include "IOWrapper/OutputWrapper/OutputWrapper_original.h"/*変更点*/
...
int main( int argc, char** argv )
{
    ...
    if(useSampleOutput)
        ...
        fullSystem->outputWrapper.push_back(new IOWrap::OutputWrapper_original());/*変更点*/
